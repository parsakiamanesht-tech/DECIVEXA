...
--> statement-breakpoint
CREATE UNIQUE INDEX "memory_records_id_user_id_unique" ON "decivexa"."memory_records" USING btree ("id","user_id");--> statement-breakpoint
...
CREATE UNIQUE INDEX "memory_record_versions_record_id_version_unique" ON "decivexa"."memory_record_versions" USING btree ("record_id","version");