...
--> statement-breakpoint
CREATE UNIQUE INDEX "personal_intelligence_relationships_id_user_id_unique" ON "decivexa"."personal_intelligence_relationships" USING btree ("id","user_id");--> statement-breakpoint
...
CREATE UNIQUE INDEX "personal_intelligence_relationship_evidence_relationship_id_sequence_unique" ON "decivexa"."personal_intelligence_relationship_evidence" USING btree ("relationship_id","sequence");